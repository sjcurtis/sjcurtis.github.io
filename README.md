...
Comments are also important and a good way to communicate with other developers. Through my code, I was intentional with inline comments to describe code blocks. With functions and methods, I would write a summary and describe parameters and returns. At the top of the code files, I would summarize the intent of the file and developers could contact me for help.
